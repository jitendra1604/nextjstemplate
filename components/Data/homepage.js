export const Homedata = [
  {
    ...
    content:
      "Accreda is a holistic career building platform that ensures learners and career professionals are always employable and job-ready.",
    buttonname: "Take a quick test",
    buttonname1: "Explore programs",
    buttonname_content:
      "Find out your employeable score for the next level career.",
    buttonname1_content: "Tailor-made next level programs designed for you.",
  },
];
...
export const Carrercontent = [
  {
    ...
    content:
      "FLY is reinventing the way we learn and grow. The platform teaches you what matters the most and is designed to keep you employable in an exciting, ever-changing world.",
    links: "Learn more",
