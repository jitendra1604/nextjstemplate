              ...
              <div className={styles.contempary_tab_content}>
                <Tab.Content>
                  <Tab.Pane eventKey="accreda_sign">
                    ...
                    <p>
                      The Signature Accreda programs help aspiring professionals
                      develop expertise in the professional area or discipline
                      of their choice by providing a holistic learning
                      experience to the learner{" "}
                    </p>
                  </Tab.Pane>
                  <Tab.Pane eventKey="accreda_booster">2</Tab.Pane>
                </Tab.Content>
              </div>
            </Col>
          </Row>
